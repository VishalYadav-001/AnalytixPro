<template>
  <div class="space-y-6 animate-fade-up">
    ...
    <div v-if="!loading && sessions.length === 0" class="empty-state">
      <div class="empty-state-icon bg-brand-50">
      ...
      >
        <div class="flex items-center gap-4">
          ...
          >
            <svg
              class="w-5 h-5"
              :class="s.is_complete ? 'text-emerald-500' : 'text-brand-500'"
          ...
          <div class="modal-panel">
            ...
            <div class="space-y-4">
              <div>
                ...
                <div
                  v-if="datasets.length > 0 && availableDatasets.length === 0"
                ...
                <p
                  v-else-if="datasets.length > availableDatasets.length"
